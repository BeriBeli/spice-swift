...
| --- | --- | --- | --- | --- |
| AIP-00 | in-progress | Establish fresh `v0.2.7` metrics and a Release `spice-bench` JSON harness | — | Microbench and live artifacts identify commit, toolchain, hardware, thermal state, workload, and date |
